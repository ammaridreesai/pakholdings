...
export const projects = [
  ...
  },
  {
    ...
    short_description:
      "Discover unparalleled luxury with our bespoke UK-imported Rolls Royce Cullinan Black Badge MANSORY Edition, featuring exclusive custom refinements and commanding presence.",
    description:
  ...
  },
  {
    ...
    short_description:
      "Elevate your driving experience with our premium Lexus LX600h, combining Japanese precision engineering, luxurious interior appointments, and eco-conscious hybrid technology.",
    description:
      "Here at Stallion Motors, we are delighted to offer this latest shape, Lexus LX600h fresh from the Japanese shores. From it's striking looks, strong character lines and sculpted creases, this flagship SUV from Lexus, is bound to fulfil all of your lifestyle requirements from a car and more Packed with a twin turbo V6 engine, paired to a potent electric hybrid system, this LX600h is a brawny Swiss Army knife that can amply seat 7 comfortably and offers spritely performance, Japanese reliability, excellent refinement and exceptional fuel economy For more details, kindly contact us to make a query",
    tags: [
      "Luxury Car",
  ...
  },
  {
    ...
    description:
      "Villa 2 is a masterpiece of contemporary architecture, offering a seamless blend of style, functionality, and luxury. Designed with open spaces and natural light in mind, it boasts an expansive living area, high ceilings, and sleek finishes. Located in a prime area, this villa is ideal for those seeking tranquility with easy access to city conveniences. The villa's private garden, outdoor lounge, and modern kitchen make it an ideal home for entertaining or relaxing in ultimate comfort.",
    tags: [
      "Luxury Home",
      "Modern Design",
      "Real Estate",
