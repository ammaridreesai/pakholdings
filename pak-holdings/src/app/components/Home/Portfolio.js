        ...
        <>
            <div className="bg-black text-white py-16">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl font-semibold mb-4">Explore Our Diverse Ventures</h2>
                    <p className="text-lg sm:text-xl">Discover our innovative projects in retail and real estate.</p>
                </div>
                    ...
                    <div className="flex flex-col ml-[64px] mr-[64px">
                        ...
                        <div className="relative flex flex-col ">
                            ...
                            <div className="py-[14px] text-white">
                                ...
                                <p className="text-sm mt-2 mb-4">Transforming cityscapes with modern residential developments and vibrant community spaces.</p>
                                <div className="flex flex-wrap gap-2 mb-4">
                                    <span className="text-xs bg-transparent border border-gray-400 rounded-[8px] text-white px-3 py-1">Tag one</span>
                                    <span className="text-xs bg-transparent border border-gray-400 rounded-[8px] text-white px-3 py-1">Tag two</span>
                                    <span className="text-xs bg-transparent border border-gray-400 rounded-[8px] text-white px-3 py-1">Tag three</span>
                                </div>
