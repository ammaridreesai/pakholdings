            ...
            <div className="relative inset- flex justify-center items-center gap-[180px bg-[#053624] lg:px-[64px] ">
                <div className="w-full max-w-8xl px-4 sm:px-8 lg:px-0 py-16">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-white  lg:text-left">
                        ...
                        <div className="lg:flex lg:flex-col lg:justify-center lg:items-start lg:border lg:border-black">
                        ...
                        <div className="flex flex-col justify-start items-center lg:items-start ">
                            <p className="text-[18px] font-medium mb-[32px] max-w-3xl mx-auto lg:mx-0 leading-[150%]">
                                At Pakholding, we are dedicated to creating innovative retail and lifestyle spaces that inspire and engage.
                                Our mission is to redefine the landscape of investment and development through strategic insights and
