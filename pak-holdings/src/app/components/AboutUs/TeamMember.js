    ...
    <section className="bg-white  text-black mx-auto">
      <div className="p-16 text-center">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <p className="font-semibold mb-[16px] leading-[24px]  text-[18px]">
            Team
          </p>
          <h2 className="mb-4 text-[48px] font-normal ">Our team</h2>
              ...
              {/* <ul className="flex justify-center mt-4 space-x-4">
                {member.socialLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      href={link.href}
                      className={`text-[${link.color}] hover:text-gray-900 dark:hover:text-white`}
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
